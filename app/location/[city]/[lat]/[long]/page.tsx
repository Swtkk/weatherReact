...
export default async function WeatherPage({params: {city, lat, long}}: Props) {
    ...
    console.log(new Date(results.current_weather.time))
    return (
                    ...
                    <div className={"grid grid-cols-1 xl:grid-cols-2 gap-5 m-2"}>
                        ...
                        <div>
                            ...
                            {Number(results.daily.uv_index_max[0].toFixed(1)) > 5 && (
                                <CalloutCard message={"The UV is high today, be sure to wear SPF!"}
                                             warning={true}
                                />
                            )}
                        </div>
                        ...
                        <div className={"flex space-x-3"}>
                            <StatCard title={"Wind speed"} metric={`${results.current_weather.windspeed.toFixed(1)} m/s`}
                                      color={"cyan"}
                            />
